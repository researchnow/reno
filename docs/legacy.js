...
return hyperHTML.bind(a)(N(),{any:i,placeholder:o}),hyperHTML.bind(r)(B(),{any:a}),L=on(r,"click",A),new Promise(function(e){window.requestAnimationFrame(function(){"container darwin-editor"==t.anchor.classList?r.classList.add("darwinEditor"):H(t.anchor,r,t),e(!0)})})}}function S(e){var t=(e=e||document).getElementById("reno-popup-container")
