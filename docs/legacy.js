...
break
case"bottom":u.height+s>window.innerHeight?G(t,A,u,s):u.height+s>a.bottom?(t.style.top=window.pageYOffset+"px",A.classList.add("top-20"),A.style.maxHeight=a.bottom+"px"):t.style.top=g+window.pageYOffset-u.height+"px"
break
