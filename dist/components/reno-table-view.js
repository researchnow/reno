...
var _templateObject = _taggedTemplateLiteral([''], ['']),
    _templateObject2 = _taggedTemplateLiteral(['<col class="', '"></col>'], ['<col class="', '"></col>']),
    _templateObject3 = _taggedTemplateLiteral(['<colgroup>', '</colgroup>'], ['<colgroup>', '</colgroup>']),
    _templateObject4 = _taggedTemplateLiteral(['<div class="', '" field="', '"><span>', '</span></div>'], ['<div class="', '" field="', '"><span>', '</span></div>']),
    _templateObject5 = _taggedTemplateLiteral(['<div class="thead"><div class="tr">', '</div></div>'], ['<div class="thead"><div class="tr">', '</div></div>']),
    _templateObject6 = _taggedTemplateLiteral(['<div class="', '">\n\t\t\t\t\t\t\t<div class="label">', '</div>\n\t\t\t\t\t\t\t<div class="value">', '</div></div>'], ['<div class="', '">\n\t\t\t\t\t\t\t<div class="label">', '</div>\n\t\t\t\t\t\t\t<div class="value">', '</div></div>']),
    _templateObject7 = _taggedTemplateLiteral(['<div class="', '">', '</div>'], ['<div class="', '">', '</div>']),
    _templateObject8 = _taggedTemplateLiteral(['<div class="tr">', '</div>'], ['<div class="tr">', '</div>']),
    _templateObject9 = _taggedTemplateLiteral(['', '', '<div class="tbody">', '</div>', ''], ['', '', '<div class="tbody">', '</div>', '']);
      ...
      value: function render() {
        ...
        if (!noColGroup) {
          cols = this.fieldList.map(function (field) {
            ...
            return hyperHTML.wire()(_templateObject2, cssClasses);
          }.bind(this));
          cols = hyperHTML.wire()(_templateObject3, cols);
        }
        ...
        var headRowCells = this.fieldList.filter(function (field) {
          ...
          return hyperHTML.wire()(_templateObject4, cssClasses, field, renderValue(fieldName));
        }.bind(this));
        var header = hyperHTML.wire()(_templateObject5, headRowCells);
        ...
        var bodyRows = this.page.data.map(function (o) {
          ...
          var bodyRowCells = this.fieldList.filter(function (field) {
            ...
            if (labels) {
              var fieldName = this.fieldMap[field];
              if (fieldName === undefined) fieldName = '<em>' + field + '</em>';
              return hyperHTML.wire()(_templateObject6, 'td field-' + field, renderValue(fieldName), renderValue(value));
            }
            return hyperHTML.wire()(_templateObject7, 'td field-' + field, (typeof value === 'undefined' ? 'undefined' : _typeof(value)) == 'object' ? value : { html: value });
          }.bind(this));
          return hyperHTML.wire(o)(_templateObject8, bodyRowCells);
        }.bind(this));
        ...
        this.html(_templateObject9, cols, header, bodyRows, footer);
      }
    }, {
      key: 'io',
      value: function io() {
        ...
        heya.io(this.sanitizeRequest({ url: url, method: 'GET', query: request })).then(function (page) {
          ...
          this.render();
          this.dispatchEvent(new CustomEvent('reno-table-data-updated', {
            bubbles: true,
            detail: { limit: limit, total: this.total, offset: this.realOffset, shown: this.realLimit }
          }));
