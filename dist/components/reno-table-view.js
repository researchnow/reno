...
var RenoTableView = function (_HTMLElement) {
	...
	function RenoTableView(self) {
		var _this, _ret;

		_classCallCheck(this, RenoTableView);

		self = (_this = _possibleConstructorReturn(this, (RenoTableView.__proto__ || Object.getPrototypeOf(RenoTableView)).call(this, self)), _this);
		self.page = { data: [] };
	...
	_createClass(RenoTableView, [{
		...
		value: function io() {
			...
			heya.io.get(url, this.sanitizeRequest(request)).then(function (page) {
				...
				_this4.show();
				_this4.dispatchEvent(new CustomEvent('data-updated', { bubbles: true, detail: { limit: limit, total: _this4.total, offset: _this4.realOffset } }));
			});
		}
		// event handlers
		...
		value: function onClick(e) {
			...
			for (; node && node !== this; node = node.parentNode) {
				...
				if (field) {
					...
					this.dispatchEvent(new CustomEvent('sort-requested', { bubbles: true, detail: { field: field, currentState: currentState } }));
					return;
				}
