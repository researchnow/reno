...
(function () {
  ...
  var propagateTo = function (node, name, value) {
  ...
  var RenoTable = function (_HTMLElement) {
    ...
    function RenoTable() {
      ...
      var _this2 = _possibleConstructorReturn(this, (RenoTable.__proto__ || Object.getPrototypeOf(RenoTable)).call(this));

      _this2.view = _this2.pager = _this2.counter = null;
      return _this2;
    }
    ...
    _createClass(RenoTable, [{
      ...
      value: function disconnectedCallback() {
        ...
        this.html(_templateObject); // hack to reset a template
        Object.keys(supportedEvents).forEach(function (eventName) {
